...
.. toctree::
    ...
    FortiGateAPI <fortigateapi/_contents.rst>
    FortiGate <fortigateapi/FortiGate.rst>
    REST API <rest_api/_contents.rst>
    Usage <https://github.com/vladimirs-git/fortigate-api/tree/main/examples>
